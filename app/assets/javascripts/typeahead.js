...
(function($) {
    ...
    var html = {
        ...
        suggestion: '<div class="tt-suggestion" style="white-space: nowrap; cursor: pointer;">%BODY%</div>'
    };
    var css = {
        wrapper: {
            position: "relative",
    ...
    var Dropdown = function() {
        ...
        _.mixin(Dropdown.prototype, EventEmitter, {
            ...
            _getCursor: function getCursor() {
                return this.$menu.find(".tt-is-under-cursor").first();
            },
            _setCursor: function setCursor($el, silent) {
                $el.first().addClass("tt-is-under-cursor");
                !silent && this.trigger("cursorMoved");
            },
            _removeCursor: function removeCursor() {
                this._getCursor().removeClass("tt-is-under-cursor");
            },
